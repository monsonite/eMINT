...
| a..z   | variable access           | -- n         |	:A...; | define a new command DEF        	   | --       |	 
| @      | FETCH a value from memory | -- n	    |	:@...; | define an anonymous command DEF 	   | -- a     |
| !      | STORE a value to memory   | n a --       |	       | where "A" represents any uppcase letter   |	      |
| .      | print TOS as decimal      | n --         |   ,      | print TOS as hexadecimal  		   | n --     |
| '      | DROP                      | m n -- m     |	`      | `Print string between ticks`		   |          |		
| "      | DUP                       | n -- n n     |   \      | Extended function table		   |          |
| %      | OVER			     | m n -- m n m |
| $      | SWAP                      | m n -- n m   |
